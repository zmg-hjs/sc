layui.config({
    ...
    table.render({
        ...
        , url: '/sc/manage/staff/manage_staff_user_index_data'
        ...
        , cols: [[
            ...
            , {field: 'positionStr', title: '职位', width: 150, align: 'center'}
    ...
    table.on('tool(order-table-toolbar)', function (obj) {
        ...
        if (obj.event === 'find'){
            ...
            layer.open({
                ...
                area: [width, height],
                title: '工作人员信息',
                content: "/sc/manage/staff/manage_staff_user_find_page?id="+data.id
                ,maxmin: true
        ...
        if (obj.event === 'examine'){
            ...
            layer.open({
                ...
                area: [width, height],
                title: '工作人员信息审核页面',
                content: "/sc/manage/staff/manage_staff_user_update_page?id="+data.id
                ,maxmin: true
                ,zIndex: layer.zIndex //重点1
            });
        }
