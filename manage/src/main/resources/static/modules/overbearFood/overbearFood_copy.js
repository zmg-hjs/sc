layui.config({
    ...
    var releaseDate_init = new Date();
    laydate.render({
        elem: '#releaseDateStr'
        , type: 'datetime'
        , format: 'yyyy-MM-dd'
        , value: releaseDate_init
    });

    var lastEndDate_init = new Date();
    lastEndDate_init.setDate(lastEndDate_init.getDate() + 1);
    lastEndDate_init.setHours(23);
    lastEndDate_init.setMinutes(59);
    lastEndDate_init.setSeconds(59);
    laydate.render({
        elem: '#lastEndDateStr'
        , type: 'datetime'
        , format: 'yyyy-MM-dd'
        ,value:lastEndDate_init
    });
    //事件
    var active = {
        addRow: function () {
    ...
    function combinationAdd(){
        var setMealHtml='<div id="combination_' + combinationNumber + '" >\n' +
            ...
            '                            <label class="layui-form-label required-tag">组合类型名</label>\n' +
            ...
            '                    <div class="layui-col-xs6">\n' +
            '                        <div class="layui-form-item">\n' +
            '                            <label  class="layui-form-label required-tag">组合名</label>\n' +
            '                            <div class="layui-input-block">\n' +
            ...
            '                </div>\n' +
            '\n' +
            '                <div  class="edit-module-title">上传组合图片</div>\n' +
