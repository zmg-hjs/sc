        ...
        F.prototype.config = {
                        ...
                        t.ajax({
                            ...
                            success: function(t) {
                                "function" == typeof a.parseData && (t = a.parseData(t) || t),
                                    t[n.statusName] != 1 ? (i.renderForm(), i.layMain.html('<div class="' + f + '">' + (t[n.msgName] || "2返回的数据不符合规范，正确的成功状态码 (" + n.statusName + ") 应为：" + n.statusCode) + "</div>")) : (i.renderData(t, e, t[n.countName]), o(), a.time = (new Date).getTime() - i.startTime + " ms"),
                                    i.setColsWidth(),
                                "function" == typeof a.done && a.done(t, e, t[n.countName])
                            },
                            error: function(e, t) {
                                i.layMain.html('<div class="' + f + '">' + (window.dataRequestException || "数据接口请求异常") + "：" + t + "</div>"),
                                    i.renderForm(),
                                    i.setColsWidth()
                            }
                        })
            ...
            F.prototype.renderData = function(e, n, o, r) {
                ...
                return c.key = s.id || s.index,
                    ...
                    r ? m() : 0 === u.length ? (c.renderForm(), c.layFixed.remove(), c.layMain.find("tbody").html(""), c.layMain.find("." + f).remove(), c.layMain.append('<div class="' + f + '">' + (window.noData || s.text.none) + "</div>")) : (m(), c.renderTotal(u), void(s.page && (s.page = t.extend({
                            elem: "layui-table-page" + s.index,
                            count: o,
                            limit: s.limit,
                            limits: s.limits || [10, 20, 50, 100, 500, 1000, 2000, 5000],
                            groups: 3,
                ...
                var g = "layui-table-grid-down",
                    b = function(e) {
                        ...
                        if (e) {
                            ...
                            if (a.prop("scrollWidth") > a.outerWidth()) {
                                if (a.find("." + g)[0]) {
                                    return
                                }
