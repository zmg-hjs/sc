...
public class StaffUserService {
    ...
    public StaffUserEntity findUserEntityById(String id){
        return staffUserRepository.findUserEntityById(id);
    }
    ...
    public Result<StaffUserEntity> login(WeChatEntity weChatEntity){
        ...
        //根据openId查询是否存在改用户
        StaffUserEntity staffUserEntity = staffUserRepository.findUserEntityByOpenId(weChatEntity.getOpenId());
    ...
    public Result register(RegisterDto registerDto){
        //判断是否存在该用户
        StaffRegistrationEntity staffRegistrationEntity = staffRegistrationRepository.findUserEntityByIdNumber(registerDto.getIdNumber());
    ...
    public Result<StaffUserEntity> automaticLogin(WeChatEntity weChatEntity){
        ...
        StaffUserEntity staffUserEntity = staffUserRepository.findUserEntityByOpenId(weChatEntity1.getOpenId());
