layui.config({
    ...
    table.render({
        ...
        , cols: [[
            ...
            , {field: 'shopName', title: '店铺名', fixed: 'left', minWidth: 100, align: 'left'}
            , {field: 'overbearFoodId', title: '霸王餐id', fixed: 'left', minWidth: 100, align: 'left'}
            , {field: 'userId', title: '用户id', width: 100, align: 'left'}
            , {field: 'foodType', title: '产品类型', width: 100, align: 'left'}
            , {field: 'releaseDate', title: '发布日期', width: 150, align: 'left'}
            , {field: 'statusStr', title: '状态', width: 100, align: 'left'}
            , {field: 'result', title: '反馈结果', width: 100, align: 'left'}
            , {field: 'registrationFee', title: '报名费', width: 100, align: 'left'}
            , {field: 'payMoney', title: '支付金额', width: 100, align: 'left'}
            , {field: 'createDate', title: '创建时间', width: 150, align: 'left'}
            , {field: 'updateDate', title: '更新时间', width: 150, align: 'left'}
