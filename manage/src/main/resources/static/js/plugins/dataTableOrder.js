...
function showTableDataNew(url,values,allcolumns,addessNodes,showNm){
    ...
    $('#dataTable').dataTable({
    	...
    	"aLengthMenu":[10,50,100,500,1000,2000], //设置显示多少条记录
    	"fnServerData": function(sSource, aoData, fnCallback){
    	  $.ajax( { 
    	  'type' : 'post', 
    	  "url": sSource, 
    	  "dataType": "json", 
    	  "data": { "aodata" : JSON.stringify(aoData),"values" : JSON.stringify(values)},
